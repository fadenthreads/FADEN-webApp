  ...
  return (
    <>
      <section
        ...
        className="faden-hero-brand relative flex min-h-[calc(100dvh-7.5rem)] flex-col overflow-hidden md:min-h-[calc(100dvh-8.5rem)]"
      >
        {/* Full-screen logo — fades + rises into view */}
        <div className="flex flex-1 flex-col items-center justify-center px-4 py-8 md:py-10">
          <motion.div
            initial={reducedMotion ? false : { opacity: 0, scale: 0.88, y: 32 }}
          ...
          >
            <Image
              ...
              height={1060}
              priority
              className="h-[min(72vh,700px)] w-auto object-contain"
            />
          </motion.div>
        </div>

        {/* CTAs + stats — slide up after logo appears */}
        <motion.div
        ...
        >
          <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between lg:gap-12">
            <div className="max-w-2xl">
              <motion.div variants={fadeUp} transition={fadeUpTransition} className="border-t border-navy/10 pt-5">
