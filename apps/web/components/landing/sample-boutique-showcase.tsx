...
export function SampleBoutiqueShowcase() {
  ...
  return (
    <section id="sample-boutique" className="scroll-mt-[160px] border-t border-navy/8 px-4 py-10 md:py-section-gap lg:px-12">
      <motion.div
      ...
      >
        <motion.div variants={fadeUp} transition={fadeUpTransition} className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-foreground-muted md:text-base">
            This is a preview of how verified boutiques appear — portfolio, reviews, location, and direct connect.
          </p>
        </motion.div>
        ...
        <motion.article
          ...
          className="mt-8 overflow-hidden rounded-2xl border border-navy/12 bg-background-elevated shadow-md md:mt-10"
        >
          <div className="grid md:grid-cols-2">
            <div className="relative aspect-[4/5] min-h-[280px] md:aspect-auto md:min-h-[420px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-navy/50 via-transparent to-transparent md:hidden" />
            ...
            <div className="flex flex-col justify-center p-6 md:p-10">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-xs text-foreground-muted">· {boutique.experience}</span>
              </div>

              <h3 className="mt-3 font-display text-2xl font-semibold text-navy md:text-3xl">{boutique.name}</h3>
              ...
              <blockquote className="mt-6 rounded-xl border border-gold/25 bg-gold/5 p-4">
                <p className="text-sm italic leading-relaxed text-navy/80">&ldquo;{boutique.highlightReview.text}&rdquo;</p>
                <footer className="mt-2 text-xs font-medium text-foreground-muted">
